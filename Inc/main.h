...
#define LED1_PIN                           LL_GPIO_PIN_0 // Verde
#define LED2_PIN                           LL_GPIO_PIN_1 // Amarillo
#define LED3_PIN                           LL_GPIO_PIN_14 // Rojo
#define LED1_GPIO_PORT                     GPIOB // Verde
#define LED2_GPIO_PORT                     GPIOE // Amarillo
#define LED3_GPIO_PORT                     GPIOB // Rojo
